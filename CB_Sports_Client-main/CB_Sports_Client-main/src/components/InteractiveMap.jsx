    ...
    <div className="w-full rounded-2xl overflow-hidden border border-gray-200 bg-white">
      ...
      <div className="relative h-64 bg-gradient-to-br from-blue-100 to-green-100">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s-shop+ff0000(${position[1]},${position[0]})/${position[1]},${position[0]},15,0/400x300@2x?access_token=${import.meta.env.VITE_MAPBOX_TOKEN || ""})`,
          }}
        />
