...
const Add = ({ token }) => {
  ...
  return (
    <div className="min-h-screen p-3 bg-gray-50 sm:p-4 lg:p-6">
      <div className="bg-white border border-gray-200 shadow-sm xl:max-w-5xl rounded-xl">
        <div className="p-4 sm:p-6 lg:p-8">
          <div className="flex items-center gap-3 mb-6 sm:mb-8">
            ...
            <div>
              <Title className="text-xl font-bold text-gray-800 sm:text-2xl">
                Add New Product
              </Title>
          ...
          >
                      ...
                      <label htmlFor={imageKey} className="block">
                        <div className="relative group cursor-pointer border-2 border-dashed border-gray-300 rounded-lg p-4 hover:border-gray-400 transition-colors duration-200 min-h-[120px] flex flex-col items-center justify-center bg-white">
                          {imageFiles[imageKey] ? (
                            ...
                            <>
                              <IoMdCloudUpload className="mb-2 text-3xl text-gray-400" />
                              <span className="text-xs text-gray-600">
              ...
              <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 sm:gap-6">
                ...
                <div className="lg:col-span-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 mt-1 border border-gray-300 rounded-md resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    rows={4}
                    name="description"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2 mt-1 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="special_offers">Size</option>
            ...
            {/* Tags */}
            <div className="p-4 rounded-lg bg-gray-50 sm:p-6">
              <h3 className="mb-4 text-lg font-semibold text-gray-800">Tags</h3>
            ...
            <div className="flex justify-end pt-6 border-t border-gray-200">
              <button
                disabled={isLoading}
                type="submit"
                className="flex items-center px-8 py-3 space-x-2 font-medium text-white transition-colors duration-200 bg-blue-600 rounded-lg hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
                {isLoading ? (
                  <>
                    <SmallLoader />
